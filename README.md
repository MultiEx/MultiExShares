...
`$ curl -sL "https://raw.githubusercontent.com/MultiEx/multiexshares/master/scripts/multi_installer.sh" | bash `
...
- `git clone https://github.com/MultiEx/multiexshares/`
- `cd turtlecoin`
- `mkdir build && cd $_`
- `cmake ..`
- `make`
...
- `git clone https://github.com/MultiEx/multiexshares/ muex`
- `cd muex`
- `mkdir build && cd $_`
...
Run `./src/muexd` to connect to the network and let it sync (it may take a while).
...
Hi MueX contributor, thanks for forking and sending back Pull Requests. Extensive docs about contributing are in the works or elsewhere. For now this is the bit we need to get into all the files we touch. Please add it to the top of the files, see [src/CryptoNoteConfig.h](https://github.com/MultiEx/multiexshares/) for an example.

```
// Copyright (c) 2012-2017, The CryptoNote developers, The Bytecoin developers
// Copyright (c) 2014-2018, The Monero Project
// Copyright (c) 2018, The TurtleCoin Developers
// Copyright (c) 2018, The MultiEx Developers
//
